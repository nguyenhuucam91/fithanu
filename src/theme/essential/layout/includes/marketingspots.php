...
<div class="row-fluid" id="marketing-spots">
    ...
    <div class="marketing-spot span4">
        ...
        <h5><span><i
                    class="fa fa-<?php echo \theme_essential\toolbox::get_setting('marketing1icon'); ?>"></i> <?php echo \theme_essential\toolbox::get_setting('marketing1', 'format_html'); ?></span>
        </h5>
    ...
    <div class="marketing-spot span4">
        <!-- Icon & title. Font Awesome icon used. -->
        <h5><span><i
                    class="fa fa-<?php echo \theme_essential\toolbox::get_setting('marketing2icon'); ?>"></i> <?php echo \theme_essential\toolbox::get_setting('marketing2', 'format_html'); ?></span>
        </h5>
    ...
    <div class="marketing-spot span4">
        <!-- Icon & title. Font Awesome icon used. -->
        <h5><span><i
                    class="fa fa-<?php echo \theme_essential\toolbox::get_setting('marketing3icon'); ?>"></i> <?php echo \theme_essential\toolbox::get_setting('marketing3', 'format_html'); ?></span>
        </h5>
    ...
    <div class="span4">
        <a href="<?php echo \theme_essential\toolbox::get_setting('marketing1buttonurl'); ?>"
           target="<?php echo \theme_essential\toolbox::get_setting('marketing1target'); ?>" class="marketing-button">
            <?php echo \theme_essential\toolbox::get_setting('marketing1buttontext', 'format_html'); ?>
        </a>
    ...
    <div class="span4">
        <a href="<?php echo \theme_essential\toolbox::get_setting('marketing2buttonurl'); ?>"
           target="<?php echo \theme_essential\toolbox::get_setting('marketing2target'); ?>" class="marketing-button">
            <?php echo \theme_essential\toolbox::get_setting('marketing2buttontext', 'format_html'); ?>
        </a>
        <?php echo $OUTPUT->essential_edit_button('theme_essential_frontpage'); ?>
    </div>
    ...
    <div class="span4">
        <a href="<?php echo \theme_essential\toolbox::get_setting('marketing3buttonurl'); ?>"
           target="<?php echo \theme_essential\toolbox::get_setting('marketing3target'); ?>" class="marketing-button">
            <?php echo \theme_essential\toolbox::get_setting('marketing3buttontext', 'format_html'); ?>
        </a>
        <?php echo $OUTPUT->essential_edit_button('theme_essential_frontpage'); ?>
    </div>
</div>